...
dreamcrc(PyObject *self, PyObject *args)
{
    ...
    unsigned int i;
    int crctype;
    if (!PyArg_ParseTuple(args, "s#i", &data, &len, &crctype))
        return NULL;
...
static PyMethodDef DreamCrcMethods[] = {
    {"crc32",  dreamcrc, METH_VARARGS, "Calculate Dream's CRC32 for a data string."},
